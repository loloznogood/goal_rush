<?php
/**
 * Ce fichier permet de connecter le gestionnaire de fichier.
 * Plus d'info sur https://github.com/servocoder/RichFilemanager
 * 
...
//Pas besoin car deja fait dans l'indes.php du site
